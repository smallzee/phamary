...
<nav id="sidebar" class='bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=sales" class="nav-item nav-sales"><span class='icon-field'><i class="fa fa-coins"></i></span> Drug Obtained</a>
				...
				<a href="index.php?page=customer" class="nav-item nav-customer"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Student List</a>
